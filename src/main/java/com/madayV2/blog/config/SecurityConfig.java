...
public class SecurityConfig {
	...
	public UserDetailsService userDetailsService() {
		var user = User.builder().username("admin").password(passwordEncoder().encode("admin1234")).roles("ADMIN")
				.build();
 ...
 * 
 * @Bean //이 메서드가 반환하는 객체를 Spring이 관리하는 Bean으로 등록 다른 곳에서 @Autowired 하면 여기서 만든
 * 객체가 주입됨
 * 
